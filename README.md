...
## Specifications
The weather app uses the Open Weather Free API to fetch information about weather anywhere in the world. The API key was acquired through the Open Weather API website for free personal use.
